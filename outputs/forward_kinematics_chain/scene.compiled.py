...
STORYBOARD = {'concept_id': 'forward_kinematics_chain',
 'fps': 24,
 'resolution': [960, 540],
 'shots': [{'node_id': 'node_01',
            ...
            'objects': [{'name': 'key_light',
                        ...
                        {'name': 'base_segment',
                         'type': 'primitive',
                         'primitive': 'sphere',
                         'location': [-1.2, -0.35, 1.0],
                         'properties': {'radius': 0.08, 'color': [0.2, 0.65, 1.0]},
                         'keyframes': [{'time_sec': 0.0,
                                        'attr': 'location',
                                        'value': [-1.2, -0.35, 1.0]},
                                       {'time_sec': 2.46,
                                        'attr': 'location',
                                        'value': [-0.92, -0.17, 1.06]}]},
                        {'name': 'upper_arm_segment',
                         'type': 'primitive',
                         'primitive': 'sphere',
                         'location': [-0.75, 0.0, 1.08],
                         'properties': {'radius': 0.08, 'color': [0.32, 0.65, 0.9]},
                         'keyframes': []},
                        {'name': 'forearm_segment',
                         'type': 'primitive',
                         'primitive': 'sphere',
                         'location': [-0.29999999999999993, 0.35, 1.16],
                         'properties': {'radius': 0.08, 'color': [0.44, 0.65, 0.8]},
                         'keyframes': []},
                        {'name': 'joint_j1_sphere',
                         'type': 'primitive',
                         'primitive': 'sphere',
                         'location': [0.15000000000000013, -0.35, 1.24],
                         'properties': {'radius': 0.08, 'color': [0.56, 0.65, 0.7]},
                         'keyframes': []},
                        {'name': 'joint_j2_sphere',
                         'type': 'primitive',
                         'primitive': 'sphere',
                         'location': [0.6000000000000001, 0.0, 1.0],
                         'properties': {'radius': 0.08,
                                        'color': [0.6799999999999999, 0.65, 1.0]},
                         'keyframes': []},
                        {'name': 'end_effector_e_marker',
                         'type': 'primitive',
                         'primitive': 'sphere',
                         'location': [1.05, 0.35, 1.08],
                         'properties': {'radius': 0.08, 'color': [0.2, 0.65, 0.9]},
                         'keyframes': [{'time_sec': 0.0,
                                        'attr': 'location',
                                        'value': [1.05, 0.35, 1.08]},
                                       {'time_sec': 2.46,
                                        'attr': 'location',
                                        'value': [1.33, 0.53, 1.14]}]},
                        {'name': 'local_frame_j1',
                         'type': 'primitive',
                         'primitive': 'sphere',
                         'location': [-1.2, -0.35, 1.16],
                         'properties': {'radius': 0.08, 'color': [0.32, 0.65, 0.8]},
                         'keyframes': []},
                        {'name': 'local_frame_j2',
                         'type': 'primitive',
                         'primitive': 'sphere',
                         'location': [-0.75, 0.0, 1.24],
                         'properties': {'radius': 0.08, 'color': [0.44, 0.65, 0.7]},
                         'keyframes': []},
                        {'name': 'local_frame_e',
                         'type': 'primitive',
                         'primitive': 'sphere',
                         'location': [-0.29999999999999993, 0.35, 1.0],
                         'properties': {'radius': 0.08, 'color': [0.56, 0.65, 1.0]},
                         'keyframes': []},
                        {'name': 'soft_floor_plane',
                         'type': 'primitive',
                         'primitive': 'plane',
           ...
           {'node_id': 'node_02',
            ...
            'objects': [{'name': 'key_light',
                        ...
                        {'name': 'base_segment',
                         ...
                         'location': [-1.2, -0.35, 1.0],
                         'properties': {'radius': 0.08, 'color': [0.2, 0.65, 1.0]},
                         'keyframes': [{'time_sec': 3.0,
                                        'attr': 'location',
                                        'value': [-1.2, -0.35, 1.0]},
                                       {'time_sec': 6.116,
                                        'attr': 'location',
                                        'value': [-1.48, -0.17, 1.06]}]},
                        {'name': 'upper_arm_segment',
                         'type': 'primitive',
                         'primitive': 'sphere',
                         'location': [-0.75, 0.0, 1.08],
            ...
            'objects': [{'name': 'key_light',
                        ...
                        {'name': 'soft_floor_plane',
                         ...
                         'properties': {'size': 6.0,
                                        ...
                                        'alpha': 0.18},
                         'keyframes': []}]}]}
COMPILED_SCENE_HINTS = {'text_objects_created': 0, 'arrow_or_tracer_primitives': 0}
