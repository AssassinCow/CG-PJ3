...
STORYBOARD = {'concept_id': 'mirror_reflection',
 'fps': 24,
 'resolution': [960, 540],
            ...
            'objects': [{'name': 'key_light',
                        ...
                        {'name': 'soft_floor_plane',
                         ...
                         'properties': {'size': 6.0,
                                        ...
                                        'alpha': 0.18},
                         'keyframes': []},
                        {'name': 'bounce_points_p1_to_p5',
                         'type': 'primitive',
                         'primitive': 'sphere',
                         'location': [2.0, -0.2, 1.32],
                         'properties': {'radius': 0.08, 'color': [0.2, 0.65, 0.9]},
                         'keyframes': []},
                        {'name': 'normal_arrows_n1_to_n5',
                         'type': 'primitive',
                         'primitive': 'sphere',
